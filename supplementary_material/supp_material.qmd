...
This document provides the detailed code and supplementary materials of the article “*Levelling up: How to unlock ecological data with hierarchical generalized additive models*”.

In the article, coding example are separated into three boxes, each corresponding to one of the sections "Estimating a hierarchy of trends" (**Trends**), "Unpacking meaningful variance and covariances from noisy biological data" (**Variance**), and "Borrowing strenght to boost predictions" (**Prediction**). Most of the coding examples below rely heavily on the material and model structures presented in [Pedersen et al. (2019)](https://peerj.com/articles/6876/).
...
Set working directory to the R Project folder (i.e. HGAMS_WG)
...
mvgam::plot_mvgam_smooth(m1) # Smoothers

mvgam::plot_mvgam_randomeffects(m1) # Random effects
